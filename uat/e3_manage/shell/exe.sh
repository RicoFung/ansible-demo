...
cd ${IPOS_ANSIBLE}/ansible_scripts/${ENV} && git pull --force && git checkout ${BRANCH_ANSIBLE} && git fetch --all && git reset --hard origin/${git reset --hard origin/${BRANCH_ANSIBLE}}
# 执行ansible操作
